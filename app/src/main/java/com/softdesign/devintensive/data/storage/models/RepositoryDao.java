    ...
    */
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"REPOSITORY\" (" + //
                ...
                "\"REPOSITORY_NAME\" TEXT NOT NULL UNIQUE ," + // 2: repositoryName
                "\"USER_REMOTE_ID\" TEXT NOT NULL UNIQUE );"); // 3: userRemoteId
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Repository entity) {
        ...
        stmt.bindString(3, entity.getRepositoryName());
        stmt.bindString(4, entity.getUserRemoteId());
    }
    ...
    public Repository readEntity(Cursor cursor, int offset) {
        Repository entity = new Repository( //
            ...
            cursor.getString(offset + 2), // repositoryName
            cursor.getString(offset + 3) // userRemoteId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Repository entity, int offset) {
        ...
        entity.setRepositoryName(cursor.getString(offset + 2));
        entity.setUserRemoteId(cursor.getString(offset + 3));
     }
